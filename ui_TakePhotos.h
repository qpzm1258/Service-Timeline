...
public:
    ...
    void setupUi(QMainWindow *TakePhotosClass)
    {
        ...
        cameraLabel->setGeometry(QRect(0, -1, 640, 481));
        ...
        tabWidget->setGeometry(QRect(639, 0, 161, 481));
        QFont font;
        font.setPointSize(9);
        ...
        cardPhtotoTextLabel_2->setGeometry(QRect(0, 10, 151, 20));
        ...
        cardPhotoLabel->setGeometry(QRect(30, 30, 102, 126));
        ...
        agentPhotoLabel->setGeometry(QRect(30, 30, 102, 126));
        ...
        QWidget::setTabOrder(takePhotoBtn, nameInput);
        QWidget::setTabOrder(nameInput, IDCardNumInput);
        QWidget::setTabOrder(IDCardNumInput, comboBox_2);
        QWidget::setTabOrder(comboBox_2, readInfoBtn);
        QWidget::setTabOrder(readInfoBtn, cleanBtn);
        QWidget::setTabOrder(cleanBtn, tabWidget);
        QWidget::setTabOrder(tabWidget, agentNameInput);
        QWidget::setTabOrder(agentNameInput, agentNumInput);
        QWidget::setTabOrder(agentNumInput, readAgentBtn);
